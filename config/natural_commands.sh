...
alias write_channel='~/claude-autonomy-platform/utils/write_channel'  # Send Discord message by channel name
alias edit_message='~/claude-autonomy-platform/utils/edit_message'  # Edit Discord message by channel name and message ID
alias delete_message='~/claude-autonomy-platform/utils/delete_message'  # Delete Discord message by channel name and message ID
alias add_reaction='~/claude-autonomy-platform/utils/add_reaction'  # Add emoji reaction to Discord message
alias edit_status='~/claude-autonomy-platform/utils/edit_status'  # Update Discord bot status
alias send_image='~/claude-autonomy-platform/utils/send_image'  # Send image files to Discord channel
alias send_file='~/claude-autonomy-platform/utils/send_file'  # Send any file to Discord channel
alias fetch_image='~/claude-autonomy-platform/utils/fetch_image'  # Fetch/download images from Discord messages
